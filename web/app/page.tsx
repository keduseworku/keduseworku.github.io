...
export default function Home(){
  ...
  return <>
    ...
    <header><a className="wordmark" href="#universe">KW<span className="brand-dot"/><span className="wordmark-note">KEDUSE WORKU</span></a><nav className="site-links" aria-label="Main navigation"><a href="/research/">Research</a><a href="/cv/">Resume</a><a href="#perspective">About</a><a href="mailto:kworku2@jhu.edu">Email</a></nav></header>
    <main>
